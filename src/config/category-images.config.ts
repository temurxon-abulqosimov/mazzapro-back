export const CATEGORY_IMAGES: Record<string, string[]> = {
    ...
    // Pizza
    'pizza': [
        'https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?auto=format&fit=crop&w=800&q=80', // Classic Pizza
        'https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&w=800&q=80', // Pepperoni
    ],

    // Uzbek Traditional Food (Palov, Shashlik) - Using closest matches
    'uzbek-food': [
